...
"""
def CG_taichi(A: ti.SparseMatrix, b, x0):
...
@ti.kernel
def buildA(Abuilder: ti.sparse_matrix_builder(), mass: ti.template(), KK: ti.ext_arr()):
...
def solveWithSchurComplement(mass, p, prep, g, KK, l, c, cidx, iteration):
    ...
    Abuilder = ti.SparseMatrixBuilder(dim,dim,max_num_triplets=10000)
